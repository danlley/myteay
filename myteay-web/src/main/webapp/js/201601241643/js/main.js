$(document).ready(function() {
    ...
    $('#example61').bind('click', function(e) {
        ...
        $.Zebra_Dialog('<strong>A Wikipedia page</strong><br><br>', {
            source: {'iframe': {
                'src':  'http://192.168.1.106/myteay-web/adm/upload_single_goods',
                'height': 500
            }},
            width: 800,
    ...
    $('#confirmDetailsWithoutMoney').bind('click', function(e) {
        e.preventDefault();
        $.Zebra_Dialog('<strong>订单详情确认</strong><br><br>', {
            source: {'iframe': {
                'src':  'http://192.168.1.106/myteay-web/adm/query_goods_list',
                'height': 500,
				'cache': false,
            }},
            width: 800,
            ...
            title:  '魔沏系统结账确认窗口',
			'buttons':  [
				{caption: '优惠找零', callback: function() { alert('"Yes" was clicked')}},
				{caption: '找零', callback: function() { alert('"No" was clicked')}},
				{caption: '取消', callback: function() { alert('"Cancel" was clicked')}}
			]
        });
    });
